...
namespace Smoothget.Mkv
{
    ...
    public class MkvUtils
    {
        ...
        private class StateChunkStartTimeReceiver : IChunkStartTimeReceiver
        {
            ...
            /*implements*/
            public void SetChunkStartTime(int trackIndex, int chunkIndex, ulong chunkStartTime)
            {
                                                             ...
                                                             out ulong cuesOffsetMS)
        {
            ...
            if (trackCount > 13)
            {  // 13 is because a..m and n..z in MuxStateWriter checkpointing.
            ...
            while ((trackIndex = GetNextTrackIndex(mediaDataSource, ungetBlocks)) >= 0)
            {
                ...
                {  // Copy one more MediaSample if available.
                    // TODO: Test this.
                                                    ...
                                                    int videoTrackIndex, int trackCount)
        {
            ...
            {  // Ignore the last, incomplete line.
                                    ...
                                    MuxStateWriter muxStateWriter)
        {
            ...
            using (FileStream fileStream = new FileStream(mkvPath, fileMode))
            {
                ...
                if (!isComplete)
                {
                    ...
                    if (!isContinuable)
                    {  // Not continuing from previous state, writing an .mkv from scratch.
