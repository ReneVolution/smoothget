...
namespace Smoothget.Mp4
{
    ...
    {
        public int Start;
        public MediaDataBox(byte[] boxBytes, int start, int end)
            : base(ID.mdat)
        {
            this.Start = start;
        }
    ...
    public class MovieFragmentHeaderBox : Box
    {
        ...
        public MovieFragmentHeaderBox(byte[] boxBytes, int start, int end)
            : base(ID.mfhd)
        {
            if (end - start != 8)
            {
    ...
    public class MovieFragmentBox : Box
    {
        ...
        public MovieFragmentBox(byte[] boxBytes, int start, int end)
            : base(ID.moof)
        {
            while (start < end)
            {
    ...
    public class TfxdBox : Box
    {
        ...
        public TfxdBox(byte[] boxBytes, int start, int end)
            : base(ID.tfxd)
        {
    ...
    public class SampleDependencyTypeBox : Box
    {
        ...
        public SampleDependencyTypeBox(byte[] boxBytes, int start, int end)
            : base(ID.sdtp)
        {
    ...
    public class TfrfBox : Box
    {
        ...
        public TfrfBox(byte[] boxBytes, int start, int end)
            : base(ID.tfrf)
        {
            this.Version = Mp4Utils.ReadReverseBytes(boxBytes, 1, ref start, end)[0];
            this.Flags = Mp4Utils.ReadReverseBytes(boxBytes, 3, ref start, end);
    ...
    public class TrackFragmentHeaderBox : Box
    {
        ...
        public TrackFragmentHeaderBox(byte[] boxBytes, int start, int end)
            : base(ID.tfhd)
        {
    ...
    public class TrackRunBox : Box
    {
        ...
        public TrackRunBox(byte[] boxBytes, int start, int end)
            : base(ID.trun)
        {
            // TODO: Don't store field this.tr_flags etc. if not used.
