...
namespace Smoothget.Smooth
{
    ...
    internal class ManifestInfo
    {
        ...
        private ManifestInfo(XmlNode element, Uri uri)
        {
            ...
            foreach (XmlNode element2 in element.SelectNodes("StreamIndex"))
            {  // Automatic cast to XmlNode.
                ...
                case "H264":
                    {
                        ...
                        base.TrackEntry = new TrackEntry(
                            ...
                            VideoTrackInfo.GetAVCCodecPrivate(codecPrivateData, nalUnitLengthField));
                        break;
                    }
                case null:
                    {
